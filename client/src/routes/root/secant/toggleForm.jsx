  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (X===""||X2===""||error===""||func==="") {
        ...
        const result = calculate(X, X2, error, func);
        console.log(result);
        if (result) {
          setDataGraph(result);
        } else {
            ...
            <div className="p-4 md:p-5 space-y-4">
              <form onSubmit={handleSubmit}>
                <div className="grid gap-6 mb-3 md:grid-cols-3">
                  <div>
                    <label htmlFor="x" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                      X1
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="x2" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                      X2
                    </label>
                    <input
                      type="text"
